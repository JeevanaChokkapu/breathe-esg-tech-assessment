...
urlpatterns = [
    ...
    path(
        "api/ingest/sap-csv/",
        views.SapCsvIngestView.as_view(),
        name="sap-csv-ingest",
    ),

    path(
        "api/ingest/utility-csv/",
        views.UtilityCsvIngestView.as_view(),
        name="utility-csv-ingest",
    ),

    path(
        "api/ingest/travel-json/",
        views.TravelJsonIngestView.as_view(),
        name="travel-json-ingest",
    ),
]